    	...
    	<div class="outer-container">
        	<div class="content-outer clearfix">
                ...
                <div class="content-column">
                	<div class="lined-title"><h2>What we Do</h2></div>
                    <div class="default-text">perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</div>
                    
                    <!--List Style One-->
                    <ul class="list-style-one">
                        <li>Ut enim ad minima veniam</li>
                        <li>Quis nostrum exercitationem ullam corporis</li>
                        <li>Suscipit laboriosam nisi ut</li>
                    </ul>
                    
                    <a href="#" class="theme-btn btn-style-two">Read more <span class="sep-icon"><i class="fa fa-angle-right"></i></span></a>
                    
                </div>
                
                <!--Image Column-->
                <div class="image-column wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
    ...
    <section class="services-section services-style-two">
    	<div class="outer-container">
        	...
        	<div class="lined-title clearfix">
            	<div class="pull-left"><h2>Services we<br>provide</h2></div>
                <div class="text pull-left">Perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis.</div>
            </div>
            ...
            <div class="outer-box">
            	<div class="row clearfix">
                    ...
                    <div class="service-box-two col-lg-4 col-md-6 col-xs-12">
                        <div class="inner-box">
                            <div class="icon-box"><span class="icon flaticon-police-badge"></span></div>
                            <h3>Branding</h3>
                            <div class="text">Accusamus et iusto odio dignissimos ducimus qui blanditiis.</div>
                        </div>
                    </div>
                    ...
                    <div class="service-box-two col-lg-4 col-md-6 col-xs-12">
                        <div class="inner-box">
                            <div class="icon-box"><span class="icon flaticon-cercis"></span></div>
                            <h3>Design</h3>
                            <div class="text">Accusamus et iusto odio dignissimos ducimus qui blanditiis.</div>
                        </div>
                    </div>
                    ...
                    <div class="service-box-two col-lg-4 col-md-6 col-xs-12">
                        <div class="inner-box">
                            <div class="icon-box"><span class="icon flaticon-web-2"></span></div>
                            <h3>Development</h3>
                            <div class="text">Accusamus et iusto odio dignissimos ducimus qui blanditiis.</div>
                        </div>
                    </div>
                    ...
                    <div class="service-box-two col-lg-4 col-md-6 col-xs-12">
                        <div class="inner-box">
                            <div class="icon-box"><span class="icon flaticon-clipboard"></span></div>
                            <h3>Application</h3>
                            <div class="text">Accusamus et iusto odio dignissimos ducimus qui blanditiis.</div>
                        </div>
                    </div>
                    ...
                    <div class="service-box-two col-lg-4 col-md-6 col-xs-12">
                        <div class="inner-box">
                            <div class="icon-box"><span class="icon flaticon-mixer"></span></div>
                            <h3>Customization</h3>
                            <div class="text">Accusamus et iusto odio dignissimos ducimus qui blanditiis.</div>
                        </div>
                    </div>
                    ...
                    <div class="service-box-two col-lg-4 col-md-6 col-xs-12">
                        <div class="inner-box">
                            <div class="icon-box"><span class="icon flaticon-tool-3"></span></div>
                            <h3>Support</h3>
                            <div class="text">Accusamus et iusto odio dignissimos ducimus qui blanditiis.</div>
                        </div>
                    </div>
