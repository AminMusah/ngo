<template>
  <div>
            ...
            <!-- 
              ...
              >
                <div class="bigger-heading">
                  <span class="theme_color">Building The</span><br /><strong
                    >World</strong
                  >
              ...
              <div class="lower-content">
                ...
                <div class="donation-scale">
                  ...
                  <div class="progress-box">
                    <div
                      class="bar-fill scroll-able-bar"
                      data-percent="70%"
                    ></div>
                  </div>
    ...
    <section class="latest-events-section">
      <div class="outer-container">
        <div class="lined-title"><h2>Latest Events</h2></div>
        ...
        <div class="row clearfix">
          ...
          <div class="column">
            ...
            <div
              class="event-post post-style-one wow fadeInLeft"
              data-wow-delay="0ms"
              data-wow-duration="1500ms"
            >
          ...
          <div class="sortable-masonry"> -->
            ...
            <!-- <div class="filters text-center">
              <ul class="filter-tabs filter-btns clearfix">
                ...
                <li class="filter" data-role="button" data-filter=".education">
                  Education
                </li>
                <li class="filter" data-role="button" data-filter=".food">
                  Food
                </li>
                <li class="filter" data-role="button" data-filter=".water">
                  Water
                </li>
                <li class="filter" data-role="button" data-filter=".africa">
                  Africa
                </li>
                <li class="filter" data-role="button" data-filter=".asia">
                  Asia
                </li>
              </ul>
            </div> -->
          ...
          <div class="product-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <div class="inner-box">
              <figure class="image-box">
                <a href="shop.html"
                  ><img
                    src="@/assets/images/resource/products/image-1.jpg"
                    alt=""
                /></a>
                <div class="options">
                  <a
                    href="@/assets/images/resource/products/image-1.jpg"
                    class="lightbox-image"
                    title="Image Caption Here"
                    ><span class="icon flaticon-add-1"></span
                  ></a>
                  <a href="shop-single.html" class="add-cart-btn"
                    ><span class="icon flaticon-shopping-cart-1"></span
                  ></a>
                  <a href="#" class="add-fav-btn"
                    ><span class="icon flaticon-favorite"></span
                  ></a>
                </div>
              </figure>
              <div class="lower-content">
          ...
          <div class="product-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <div class="inner-box">
              <figure class="image-box">
                <a href="shop.html"
                  ><img
                    src="@/assets/images/resource/products/image-2.jpg"
                    alt=""
                /></a>
                <div class="options">
                  <a
                    href="@/assets/images/resource/products/image-2.jpg"
                    class="lightbox-image"
                    title="Image Caption Here"
                    ><span class="icon flaticon-add-1"></span
                  ></a>
          ...
          <div class="product-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <div class="inner-box">
              <figure class="image-box">
                <a href="shop.html"
                  ><img
                    src="@/assets/images/resource/products/image-3.jpg"
                    alt=""
                /></a>
                <div class="options">
                  <a
                    href="@/assets/images/resource/products/image-3.jpg"
                    class="lightbox-image"
                    title="Image Caption Here"
                    ><span class="icon flaticon-add-1"></span
                  ></a>
          ...
          <div class="product-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <div class="inner-box">
              <figure class="image-box">
                <a href="shop.html"
                  ><img
                    src="@/assets/images/resource/products/image-4.jpg"
                    alt=""
                /></a>
                <div class="options">
                  <a
                    href="@/assets/images/resource/products/image-4.jpg"
                    class="lightbox-image"
                    title="Image Caption Here"
                    ><span class="icon flaticon-add-1"></span
                  ></a>
